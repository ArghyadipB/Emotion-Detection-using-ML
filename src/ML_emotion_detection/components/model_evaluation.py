...
class ModelEvaluation:
    ...
    Attributes:
        config (ModelEvaluationConfig): Configuration object containing file paths, parameters, and other settings.
    """
    def __init__(self, config: ModelEvaluationConfig):
        ...
        Args:
            config (ModelEvaluationConfig): Configuration object containing paths for test data, 
                model files, and output directories.
        """
        self.config = config
    ...
    def eval_metrics(self, actual, pred):
        ...
        Returns:
            tuple: A tuple containing the following metrics:
                ...
                - cm_disp (ConfusionMatrixDisplay): Display object for the confusion matrix.
        """        
    ...
    def log_into_mlflow(self):
        """
        Logs model evaluation metrics, artifacts, and model information into MLflow.
        ...
        Raises:
            FileNotFoundError: If any specified file paths in the configuration are invalid.
        """        
